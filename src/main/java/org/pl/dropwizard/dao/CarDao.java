...
public interface CarDao {
  ...
  @SqlUpdate(
      "update cars set model_id = :model.id, year_production = :yearProduction,"
  ...
  @SqlQuery(
      "select * from cars c left join models m on m.id_model = c.model_id where c.id_car = :id")
  @RegisterFieldMapper(Car.class)
  ...
  @SqlQuery(
      "select * from cars c left join models m on m.id_model = c.model_id "
