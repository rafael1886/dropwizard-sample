...
public class ModelService implements ModelResource {
    ...
    public Response create(final ModelDto modelDto) {
        ...
        return status(CREATED)
                .entity(ModelMapper.toDto(modelDao.create(model)))
                .build();
    }
    ...
    public Response findById(final Long id) {
        ...
        return ok(ModelMapper.toDto(modelDao.findById(id).orElseThrow(
    ...
    public Response findAll() {
        log.info("find all");
        final Set<ModelDto> models = modelDao.findAll()
                .stream()
    ...
    private Model findBrand(ModelDto modelDto) {
        ...
        model.setBrand(brandDao.findById(modelDto.getBrand()).orElseThrow(
