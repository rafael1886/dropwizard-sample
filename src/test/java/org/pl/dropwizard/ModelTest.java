  ...
  Iterable<DynamicTest> dynamicTests() {
    return Arrays.asList(
        dynamicTest(
            "create brand",
            () -> {
              BrandDto givenBrandDto = BrandDto.builder().name("Lexus").build();
        ...
        dynamicTest(
            "create model",
            () -> {
              BrandDto givenBrandDto = BrandDto.builder().name("Mercedes-Benz").build();
              Response createBrand = brandService.create(givenBrandDto);
              BrandDto actualBrand = (BrandDto) createBrand.getEntity();
        ...
        dynamicTest(
            "update model",
            () -> {
              BrandDto givenBrandDto = BrandDto.builder().name("Fiat").build();
              Response createBrand = brandService.create(givenBrandDto);
              BrandDto actualBrand = (BrandDto) createBrand.getEntity();
        ...
        dynamicTest(
            "delete model",
            () -> {
              BrandDto givenBrandDto = BrandDto.builder().name("Honda").build();
              Response createBrand = brandService.create(givenBrandDto);
              BrandDto actualBrand = (BrandDto) createBrand.getEntity();
              ...
              WebApplicationException actualWebApplicationException =
                  assertThrows(
                      WebApplicationException.class, () -> modelService.findById(modelDto.getId()));
              ...
              assertEquals(
                  "Model not found, id = " + modelDto.getId(),
                  actualWebApplicationException.getMessage());
            }));
  }
}
